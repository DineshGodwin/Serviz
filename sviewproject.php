...
<div class="container d-flex flex-column justify-content-center">
    <div class="title">
    <h1 style="text-align:center;margin-top:90px;margin-bottom:40px;">Manage Projects</h1>
    <form id="searchForm" method="GET" action="studentprojectdetails.php">
...
<div class="comm">
    ...
    <form id="searchFormCommunity" method="GET" action="studentprojectdetails.php">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchSuggestions(column, searchTerm, dropdownContainer) {
        ...
        xhr.open("GET", "sgetSuggestions.php?column=" + column + "&searchTerm=" + searchTerm, true);
