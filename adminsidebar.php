...
<div id="sideMenu">
<div class="user"><i class="far fa-user" style="color: #324797;"></i> Hi, <?php echo isset($_SESSION['username']) ? $_SESSION['username'] : 'Guest'; ?></div>
  ...
  <a href="amanageproject.php"> Manage Project</a>
  <!-- Add more links as needed -->
  <div id="logout">
    <a href="logout.php">Logout<i class="fa-solid fa-arrow-right-from-bracket" style="color: #f3f2f2; padding-left:5px;"></i></a>
  </div>
</div>
