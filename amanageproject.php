...
<div class="container d-flex flex-column justify-content-center">
    ...
    <form id="searchForm" method="GET" action="aprojectDetails.php">
...
<div class="comm">
    ...
    <form id="searchFormCommunity" method="GET" action="aprojectDetails.php">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchSuggestions(column, searchTerm, dropdownContainer) {
        ...
        xhr.open("GET", "agetSuggestions.php?column=" + column + "&searchTerm=" + searchTerm, true);
