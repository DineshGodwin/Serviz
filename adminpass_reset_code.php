...
function send_password_reset($get_name,$get_email,$token){
    ...
    <br/><br/>
    <a href='https://localhost/teacher/adminpass_change.php?token=$token&email=$get_email'>Click me</a>";
...
if(isset($_POST['password_reset_link'])){
    ...
    $check_email = "SELECT username,email FROM admin WHERE email='$email' LIMIT 1";
...
if(isset($_POST['password_update'])){
    ...
    if(!empty($token)){
            ...
            if(mysqli_num_rows($check_token_run) > 0){
                ...
                if($new_password==$confirm_password){
                    ...
                    if($update_password_run){
                        ...
                        header("Location: adminpass_change.php?token='$token'&email='$email'");
                        exit(0);
                    }
                }
                else{
        ...
        header('Location: adminpass_change.php');
        exit(0);
    }
    }